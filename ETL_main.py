...
from sqllite_database.database import create_tables, get_db
from ETL.crud import (
...
from sqllite_database.models import Advisor
import pandas as pd
from ETL.scrapper.rapid_api_client import RapidApiLIProfileClient
from ETL.scrapper.scraper import BrokerInfoScraper
...
def main():
    ...
    # Load CSV data
    file_path = "ETL/excel_files/AdvizorPro_Person_04.24.2024-1.csv"
